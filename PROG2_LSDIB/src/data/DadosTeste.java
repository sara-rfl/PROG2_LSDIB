...
public class DadosTeste {
    ...
    public static void criarPacienteTeste() {
        ...
        p3.addFrequenciaCardiaca(98, LocalDateTime.of(2024, 3, 16, 16, 45));
        p3.addTemperatura(38.0, LocalDateTime.of(2024, 3, 15, 12, 30));
        p3.addTemperatura(37.5, LocalDateTime.of(2024, 3, 16, 17, 10));
        p3.addSaturacaoOxigenio(89.0, LocalDateTime.of(2024, 3, 12, 20, 00));
        pacientes.add(p3);
    }
